...
//CODE HERE
let jsNinja = () => {
  var ninja = 'I am a Javascript Ninja'
return ninja
}
...
let oddChecker = console.log(thatsOdd(6))
...
console.log(bestMovie('The gentleman'))
...
console.log(emailCheck('joel.san@yahoo.com'))
...
//CODE HERE
const buy = (gold) => {
  let chocofrogs = gold / 3

  return chocofrogs
}

let totalFrogs = console.log(buy(12))
...
//CODE HERE
const buy2 = (gold) => {
  let chocofrogs = Math.floor(gold / 3)

  return chocofrogs
}

let totalFrogs2 = console.log(buy2(5))
...
let arrayIsAscending = arrr(sampleArray)
